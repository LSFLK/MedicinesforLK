        ...
        <div className="testimonial">
          ...
          <div className="slide">
            <p>
              ...
              halted, causing issues with our service to our patients. SLRCS's
              contribution made things easier and allowed almost all of the
              hospital's operating rooms to continue. The donated medication is
              a critical medication that must be available in hospitals. The
              donation totaled two million rupees, and we used it to treat over
              100 patients. We are extremely grateful for the assistance
              provided,
            </p>
          </div>
