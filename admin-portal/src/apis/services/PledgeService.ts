...
export class PledgeService {
  ...
  static getUpdateComments(pledgeID: number | string) {
    return http.get<PledgeActivity[]>(
      `pledges/${pledgeID}/updatecomments`
    )
  }

  static upsertUpdateComment(pledgeID: number | string, comment: PledgeActivity) {
  ...
  static deleteUpdateComment(pledgeID: number | string, pledgeUpdateId: number) {
    return http.delete(
