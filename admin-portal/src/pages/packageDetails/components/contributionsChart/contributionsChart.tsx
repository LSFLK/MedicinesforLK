...
const renderCustomizedLabel = ({cx, cy, midAngle, innerRadius, outerRadius, percent}: PieChartLabelRendererProps) => {
...
export default function ContributionsChart({totalAmount, pledgedPercentage}: ContributionsChartProps) {
  return (
    <div className="contributionsChart">
      ...
      <div className="chart">
        <PieChart width={200} height={200}>
          <Pie
            startAngle={-270}
            data={[
              {name: 'Pending', value: totalAmount * (100-pledgedPercentage)/100},
      ...
      <p>Received: ${(totalAmount * (pledgedPercentage/100)).toFixed()}</p>
      <a href="#">See pledge status</a>
    </div>
  )
}
